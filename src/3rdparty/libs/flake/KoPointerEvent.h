...
class QMouseEvent;
class QWheelEvent;
//AFA class KoInputDeviceHandlerEvent;
//AFA class QGraphicsSceneMouseEvent;
//AFA class QGraphicsSceneWheelEvent;
...
public:
     ...
     * @param point the zoomed point in the normal coordinate system.
     */
    //AFA KoPointerEvent(QGraphicsSceneMouseEvent *event, const QPointF &point);
     ...
     * @param point the zoomed point in the normal coordinate system.
     */
    //AFA KoPointerEvent(QGraphicsSceneWheelEvent *event, const QPointF &point);
    ...
    //AFA KoPointerEvent(KoInputDeviceHandlerEvent *event, int x, int y, int z = 0, int rx = 0, int ry = 0, int rz = 0);
