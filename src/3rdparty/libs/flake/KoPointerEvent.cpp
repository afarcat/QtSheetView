...
#include <QWheelEvent>
#include <QTouchEvent>
//AFA #include <QGraphicsSceneMouseEvent>

class Q_DECL_HIDDEN KoPointerEvent::Private
{
public:
    Private()
        : tabletEvent(0), mouseEvent(0), wheelEvent(0), touchEvent(0), /*AFA gsMouseEvent(0)
    ...
    //AFA QGraphicsSceneMouseEvent *gsMouseEvent;
    //AFA QGraphicsSceneWheelEvent *gsWheelEvent;
    //AFA KoInputDeviceHandlerEvent *deviceEvent;
