 ...
 * When creating your new view you should use a KoCanvasWidget() and register that
 * with the ToolManager like this:
@code
    MyGuiWidget::MyGuiWidget() {
        m_canvasController = new KoCanvasWidget(this);
 ...
 * KoToolManager also keeps track of the current tool based on a
   ...
   - there is one active tool per KoCanvasWidget (and there is one KoCanvasWidget
...
public:
     ...
     */
    void removeCanvasController(KoCanvasWidget *controller);
    /**
    ...
    KoCanvasWidget *activeCanvasController() const;
     ...
     */
    void updateShapeControllerBase(KoShapeBasedDocumentBase *shapeController, KoCanvasWidget *canvasController);
    ...
    void requestToolActivation(KoCanvasWidget *controller);
...
Q_SIGNALS:
     ...
     */
    void changedTool(KoCanvasWidget *canvas, int uniqueToolId);
     ...
     */
    void currentLayerChanged(const KoCanvasWidget *canvas, const KoShapeLayer *layer);
     ...
     */
    void addedTool(KoToolAction *toolAction, KoCanvasWidget *canvas);
...
private:
    ...
    Q_PRIVATE_SLOT(d, void detachCanvas(KoCanvasWidget *controller))
    Q_PRIVATE_SLOT(d, void attachCanvas(KoCanvasWidget *controller))
    ...
    QPair<QString, KoToolBase*> createTools(KoCanvasWidget *controller, ToolHelper *tool);
