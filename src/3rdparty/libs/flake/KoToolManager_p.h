...
public:
    ...
    void detachCanvas(KoCanvasWidget *controller);
    void attachCanvas(KoCanvasWidget *controller);
    ...
    CanvasData *createCanvasData(KoCanvasWidget *controller, const KoInputDevice &device);
    ...
    QHash<KoCanvasWidget*, QList<CanvasData*> > canvasses;
