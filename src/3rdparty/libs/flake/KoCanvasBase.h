...
//AFA class QGraphicsObject;
//AFA class KUndo2Command;
...
public:
     ...
     * Return the widget that will be added to the scrollArea.
     */
    //AFA virtual QGraphicsObject *canvasItem() { return 0; }

    /**
     * Return the widget that will be added to the scrollArea.
     */
    //AFA virtual const QGraphicsObject *canvasItem() const{ return 0; }
     ...
     */
    KoCanvasWidget *canvasController() const;
    ...
    /// called by KoCanvasWidget to set the controller that handles this canvas.
    void setCanvasController(KoCanvasWidget *controller);
