...
//AFA #include <QtWidgets/qtwidgetsglobal.h>
#include <QtCore/qobject.h>
#include <QtCore/qstring.h>

//AFA QT_REQUIRE_CONFIG(undocommand);
...
class /*AFA Q_WIDGETS_EXPORT*/ QUndoCommand
{
...
class /*AFA Q_WIDGETS_EXPORT*/ QUndoStack : public QObject
{
    Q_OBJECT
