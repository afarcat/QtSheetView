...
//AFA #if QT_CONFIG(undogroup)
//AFA #include "qundogroup.h"
//AFA #endif
#include "kundostack_p.h"
...
{
//AFA #if QT_CONFIG(undogroup)
    //AFA if (QUndoGroup *group = qobject_cast<QUndoGroup*>(parent))
    //AFA     group->addStack(this);
//AFA #endif
}
...
//AFA #if !QT_CONFIG(undogroup)
    //AFA return true;
//AFA #else
    //AFA Q_D(const QUndoStack);
    //AFA return d->group == 0 || d->group->activeStack() == this;
    return true;
//AFA #endif
}
...
#include "moc_kundostack_p.cpp"

//AFA #endif // QT_CONFIG(undostack)
