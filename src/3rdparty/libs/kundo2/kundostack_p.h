...
//AFA #include <QtWidgets/private/qtwidgetsglobal_p.h>
#include <private/qobject_p.h>
#include <QtCore/qlist.h>
#include <QtCore/qstring.h>
//AFA #include <QtWidgets/qaction.h>
...
public:
    QUndoStackPrivate() : index(0), clean_index(0), /*AFA group(0), */undo_limit(0) {}

    QList<QUndoCommand*> command_list;
    QList<QUndoCommand*> macro_stack;
    int index;
    int clean_index;
    //AFA QUndoGroup *group;
    int undo_limit;
