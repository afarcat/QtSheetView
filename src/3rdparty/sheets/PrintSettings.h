...
public:
     ...
     * \see KoPageLayout
     */
    //AFA const KoPageLayout& pageLayout() const;

    //AFA void setPageLayout(const KoPageLayout& pageLayout);

    //AFA void setPageFormat(KoPageFormat::Format format);
    //AFA void setPageOrientation(KoPageFormat::Orientation orientation);
