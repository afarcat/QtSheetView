...
//AFA #include "part/View.h" // TODO: get rid of this dependency
...
{
    Q_ASSERT(part);
    //AFA d->resourceManager = new KoDocumentResourceManager();
...
bool DocBase::saveOdf(SavingContext &documentContext)
{
    ...
    //AFA return Odf::saveDocument(this, documentContext);
    return false;
}

bool DocBase::loadOdf(KoOdfReadStore & odfStore)
{
    //AFA return Odf::loadDocument(this, odfStore);
    return false;
}
