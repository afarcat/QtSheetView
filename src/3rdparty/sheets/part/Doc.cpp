...
//AFA #include <KoOasisSettings.h>
//AFA #include <KoDocumentResourceManager.h>
//AFA #include <KoShapeConfigFactoryBase.h>
//AFA #include <KoShapeFactoryBase.h>
//AFA #include <KoShapeRegistry.h>
#include <KoXmlNS.h>
#include <KoXmlWriter.h>
#include <KoZoomHandler.h>
//AFA #include <KoShapeSavingContext.h>
...
// D-Bus
#ifndef QT_NO_DBUS
//AFA #include "interfaces/MapAdaptor.h"
//AFA #include "interfaces/SheetAdaptor.h"
//AFA #include <QDBusConnection>
#endif

// chart shape
//AFA #include "plugins/chartshape/ChartShape.h"
//AFA #include "chart/ChartDialog.h"
...
#ifndef QT_NO_DBUS
    //AFA new MapAdaptor(d->map);
    //AFA QDBusConnection::sessionBus().registerObject('/' + objectName() + '/' + d->map->objectName(), d->map);
#endif
...
void Doc::initConfig()
{
    ...
    const int page = 1; //AFA config->group("Tables Page Layout").readEntry("Default unit page", 0);
