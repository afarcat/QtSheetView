...
public:
    ...
    View(/*AFA KoPart *part, */QWidget *parent = nullptr, Doc *document = nullptr);
...
protected: // reimplementations
    ...
    //AFA virtual KoPrintJob * createPrintJob();
public:
    //AFA virtual KoZoomController *zoomController() const;
