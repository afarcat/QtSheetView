        ...
        , d(new Private)
{
    ...
    // flake
    //AFA d->shapeManager = new KoShapeManager(this);
    d->toolProxy = new KoToolProxy(this);
}

CanvasBase::~CanvasBase()
{
    //AFA delete d->shapeManager;
    delete d->toolProxy;
...
{
    return nullptr; //AFA d->shapeManager;
}
...
//     painter.save();
    ...
    //AFA d->shapeManager->paint(*painter, *viewConverter(), false);
//     painter.restore();
