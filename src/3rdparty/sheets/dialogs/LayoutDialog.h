...
//AFA #include <kpagedialog.h>
#include <QDialog>
#define KPageDialog QDialog
...
//AFA class KoUnitDoubleSpinBox;
#define KoUnitDoubleSpinBox QDoubleSpinBox
class QSpinBox;
class QPixmap;
class QRadioButton;
class QPushButton;
...
//AFA class KLineEdit;
#define KLineEdit QLineEdit
class QFrame;
class QListWidget;
class QCheckBox;
//AFA class KColorButton;
#define KColorButton QPushButton
//AFA class KComboBox;
...
protected:
    ...
    QDialogButtonBox *buttonBox;    //AFA
