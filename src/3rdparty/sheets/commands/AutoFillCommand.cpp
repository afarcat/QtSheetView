        ...
        , m_otherEnd(0)
{
    if (cell.isFormula()) {
        ...
        if (AutoFillCommand::other == 0) {
            ...
            //AFA KSharedConfigPtr config = KSharedConfig::openConfig();
            //AFA AutoFillCommand::other = new QStringList(config->group("Parameters").readEntry("Other list", QStringList()));
        }
